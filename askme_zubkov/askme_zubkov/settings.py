"""
Django settings for askme_zubkov project.
...
SECRET_KEY = 'django-insecure-xu7xp0u8a%!)94_c+a@4e4l5&(zd12l$f36=jblec0ax2okpxq'
...
ROOT_URLCONF = 'askme_zubkov.urls'
...
PASSWORD_HASHERS = [
    "django.contrib.auth.hashers.MD5PasswordHasher", # этот хешер используется django inside make_pawword(): в get_hashers()
